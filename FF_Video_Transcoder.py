...
def maximize_terminal():
    ...
    if current_platform == "Darwin":  # macOS
        ...
        pwshellcmd = 'powershell -command "& {Add-Type -TypeDefinition \'public class P { [DllImport(\\"user32.dll\\")] public static extern bool ShowWindowAsync(IntPtr hWnd, int nCmdShow); }\' -Language CSharp; $hWnd = (Get-Process -Id $pid).MainWindowHandle; [void] (P::ShowWindowAsync($hWnd, 3))}"'
